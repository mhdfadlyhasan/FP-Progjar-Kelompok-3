...
class UiFTPClient(object):
    def setupUi(self, FTPClient):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(139, 29, 871, 531))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.localTreeDir.sizePolicy().hasHeightForWidth())
        self.localTreeDir.setSizePolicy(sizePolicy)
        self.localTreeDir.setObjectName("localTreeDir")
        self.containerLocalDir.addWidget(self.localTreeDir)
        self.localListFile = QtWidgets.QListView(self.horizontalLayoutWidget)
        self.localListFile.setObjectName("localListFile")
        self.containerLocalDir.addWidget(self.localListFile)
        ...
        self.remoteTreeDir = QtWidgets.QTreeView(self.horizontalLayoutWidget)
        self.remoteTreeDir.setObjectName("remoteTreeDir")
        self.containerRemoteDir.addWidget(self.remoteTreeDir)
        self.remoteListFile = QtWidgets.QListView(self.horizontalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.remoteListFile.sizePolicy().hasHeightForWidth())
        self.remoteListFile.setSizePolicy(sizePolicy)
        self.remoteListFile.setObjectName("remoteListFile")
        self.containerRemoteDir.addWidget(self.remoteListFile)
